@extends('layouts.app')
@push('pg_btn')
    {{-- <a href="{{route('cashbill.index')}}" class="btn btn-sm btn-neutral">All Parties</a> --}}
@endpush
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-5">
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => ['cashbill.update', $cashbill], 'method'=>'put', 'files' => true]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                        {{ Form::text('door_open', $cashbill->door_open, ['class' => 'form-control mb-4']) }}
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                        {{ Form::text('hamali', $cashbill->hamali, ['class' => 'form-control mb-4']) }}
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                        {{ Form::text('salestax', $cashbill->salestax, ['class' => 'form-control mb-4']) }}
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                        {{ Form::text('door_delivery', $cashbill->door_delivery, ['class' => 'form-control mb-4']) }}
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                        {{ Form::text('total_amount', $cashbill->total_amount, ['class' => 'form-control mb-4']) }}
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    {{-- {{ Form::text('delivered_to_id', $cashbill->print_type, ['class' => 'form-control']) }} --}}
                                    {!! Form::select('delivered_to_id', $partydetails, $cashbill->delivered_to_id, ['class' => 'form-control select2']) !!}
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    {{ Form::label('delivered_by', 'Delivered by ', ['class' => 'form-control-label']) }}
                                    {{ Form::text('delivered_by', $cashbill->delivered_by, ['class' => 'form-control']) }}
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    {{ Form::label('delivered_taken_id', 'Delivered Taken by ', ['class' => 'form-control-label']) }}
                                    {{-- {{ Form::text('delivered_taken_id', $cashbill->print_type, ['class' => 'form-control']) }} --}}
                                    {!! Form::select('delivered_taken_id', $driverdetails, $cashbill->delivered_taken_id, ['class' => 'form-control select2']) !!}
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    {{ Form::label('payment_type', 'Payment Type ', ['class' => 'form-control-label']) }}
                                    {{-- {{ Form::text('payment_type', $cashbill->print_type, ['class' => 'form-control']) }} --}}
                                    {!! Form::select('payment_type', $partypaymenttype, $cashbill->payment_type, ['class' => 'form-control select2']) !!}
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    {{ Form::label('print_type', 'Do you want to Print?', ['class' => 'form-control-label']) }}
                                    {{-- {{ Form::text('print_type', $cashbill->print_type, ['class' => 'form-control']) }} --}}
                                    {!! Form::select('print_type', $print_types, $cashbill->print_type, ['class' => 'form-control select2']) !!}
                                </div>
                            </div>
                        </div>
